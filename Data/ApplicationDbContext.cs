...
namespace Viajajunto.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        // Configuração do mapeamento das entidades e seus relacionamentos
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);

            // Relacionamento entre User e Itinerary (1-N)
            ...
            // Relacionamento entre Itinerary e MarkPoint (1-N)
            ...
            // Relacionamento entre User e Post (1-N)
            ...
            // Relacionamento entre MarkPoint e Post (1-N)
            modelBuilder.Entity<Post>()
            ...
            // Relacionamento entre Post e PostImage (1-N)
            ...
            // Relacionamento entre Post e PostLike (1-N)
            ...
            // Relacionamento entre User e PostLike (1-N)
            modelBuilder.Entity<PostLike>()
                .HasOne(pl => pl.User)
            ...
            // Relacionamento entre Post e PostComment (1-N)
            ...
            // Relacionamento entre User e PostComment (1-N)
            modelBuilder.Entity<PostComment>()
                .HasOne(pc => pc.User)
            ...
            // Relacionamento entre Post e PostShare (1-N)
            ...
            // Relacionamento entre User e PostShare (1-N)
            modelBuilder.Entity<PostShare>()
                .HasOne(ps => ps.User)
            ...
            // Relacionamento entre Post e PostTag (muitos-para-muitos)
            ...
            // Relacionamento entre User e Friendship (1-N)
            ...
            // Relacionamento entre User e Message (1-N)
